        ...
        <div className="w-full max-w-[1200px] h-full flex justify-between items-center px-10">
          ...
          <div className="flex items-center justify-center gap-x-8 w-full sm:w-auto">
            ...
            <ul className="hidden sm:flex gap-x-8">
              <li>
                <Link className="hover:text-[#FB2E86]" href={"/"}>
                  Home
                </Link>
              </li>
              <li>
                <Link className="hover:text-[#FB2E86]" href={"/pages"}>
                  Pages
                </Link>
              </li>
              <li>
                <Link className="hover:text-[#FB2E86]" href={"/products"}>
                  Products
                </Link>
              </li>
              <li>
                <Link className="hover:text-[#FB2E86]" href={"/blog"}>
                  Blog
                </Link>
              </li>
              <li>
                <Link className="hover:text-[#FB2E86]" href={"/shop"}>
                  Shop
                </Link>
              </li>
              <li>
                <Link className="hover:text-[#FB2E86]" href={"/contact"}>
                  Contact
                </Link>
              </li>
            </ul>
            ...
            {/* Search Bar */}
            <div className="hidden sm:flex items-center border rounded-md overflow-hidden bg-white">
              <input
                type="text"
