    ...
    <div className="bg-gray-100 py-16 text-gray-600">
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <div className="flex justify-between items-center w-[90%] mx-auto">
          <p className="text-gray-500">&copy; Webecy - All Rights Reserved. Ayesha Waseem</p>
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/share/1DSUv5HjDh/" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaFacebookF />
            </a>
            <a href="@ayesha_waseem" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaTwitter />
            </a>
            <a href="https://www.instagram.com/ayeshawaseem27?igsh=Mjh6M2s3eHllZjFs" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaInstagram />
            </a>
          </div>
        </div>
